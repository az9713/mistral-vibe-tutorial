...
> [!NOTE]
> **This repository is a clone of the upstream [`mistralai/mistral-vibe`](https://github.com/mistralai/mistral-vibe)**, enhanced with a deep-dive learning guide ([`docs_deepdive/`](docs_deepdive/)) for onboarding and learning how to code a minimal CLI coding agent. The upstream code is unchanged; the additions are documentation only.
>
> Start here:
